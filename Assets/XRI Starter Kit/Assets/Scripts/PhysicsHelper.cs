...
public static class PhysicsHelper
{
    ...
    /// <param name="physicsFramesToWait">Number of fixed update frames to wait before disabling.</param>
    public static IEnumerator MoveAndDisableCollider(Collider collider, Vector3 resetLocalPosition, int physicsFramesToWait = 2)
    {
    ...
    public static void SimulateTriggerExit(Collider collider)
    {
        ...
        Vector3 halfExtents = collider.bounds.extents * 0.5f; // somewhat smaller if you want to avoid false positives
